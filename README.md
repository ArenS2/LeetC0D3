...
- Let's get started:
	- Đầu tiên, tạo ngẫu nhiên 2 số nguyên tố `p`, `q` khác nhau (`prime1`, `prime2`) (2 số này càng lớn thì thuật toán RSA càng bảo mật)
...
- Đấy cơ bản chỉ có vậy thôi. Tiếp theo demo phát cho nó nóng:
### Example:
- Đầu tiên, chọn 2 số nguyên tố ngâu nhiên khác nhau: `p = 7` và `q = 13`
